...
$(document).ready(function(){
	...
	$('#confirm').on('click', function() {
		...
		var content = $('#content').val().trim();
			...
			var UserPassword = document.board_form.password;
...
<body>
	<form id="board_form" name="board_form" action="boardinsert" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
		<div class="container" style="text-align: center">
			...
			<div class="row">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input type="text" id="title" name="title" class="form-control" maxlength="30" required="true">
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
			...
			<div class="row" style="margin-top: 30px">
				...
				<div class="col-md-2">
					<button type="button" id="cancel" onclick="location.href='boardpagelist'" class="btn btn-primary btn-block">취소</button>
				</div>
				<div class="col-md-2">
